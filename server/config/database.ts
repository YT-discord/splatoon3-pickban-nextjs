...
export const initializeDB = async () => {
  try {
    await sequelize.sync({ force: true }); //データベースを作り直す場合は await sequelize.sync({ force: true });
    ...
    const masterWeaponsData: CreationAttributes<WeaponModel>[] = [
      ...
      {"id":12, "name":"52ガロンデコ","attribute":"シューター","imageUrl":"52ガロンデコ.webp", "subWeapon":"カーリングボム", "specialWeapon":"スミナガシート", "subWeaponImageName":"カーリングボム", "specialWeaponImageName":"スミナガシート"},
      ...
      // --- ローラー ---
      {"id":29, "name":"カーボンローラー","attribute":"ローラー","imageUrl":"カーボンローラー.webp", "subWeapon":"ロボットボム", "specialWeapon":"ショクワンダー", "subWeaponImageName":"ロボットボム", "specialWeaponImageName":"ショクワンダー"},
      ...
      {"id":42, "name":"スプラチャージャーコラボ","attribute":"チャージャー","imageUrl":"スプラチャージャーコラボ.webp", "subWeapon":"スプラッシュシールド", "specialWeapon":"トリプルトルネード", "subWeaponImageName":"スプラッシュシールド", "specialWeaponImageName":"トリプルトルネード"},
      ...
      {"id":44, "name":"スプラスコープコラボ","attribute":"チャージャー","imageUrl":"スプラスコープコラボ.webp", "subWeapon":"スプラッシュシールド", "specialWeapon":"トリプルトルネード", "subWeaponImageName":"スプラッシュシールド", "specialWeaponImageName":"トリプルトルネード"},
      ...
      {"id":50, "name":"14式竹筒銃・乙","attribute":"チャージャー","imageUrl":"14式竹筒銃・乙.webp", "subWeapon":"タンサンボム", "specialWeapon":"デコイチラシ", "subWeaponImageName":"タンサンボム", "specialWeaponImageName":"デコイチラシ"},
      ...
      {"id":56, "name":"バケットスロッシャーデコ","attribute":"スロッシャー","imageUrl":"バケットスロッシャーデコ.webp", "subWeapon":"ラインマーカー", "specialWeapon":"ショクワンダー", "subWeaponImageName":"ラインマーカー", "specialWeaponImageName":"ショクワンダー"},
      ...
      {"id":59, "name":"スクリュースロッシャー","attribute":"スロッシャー","imageUrl":"スクリュースロッシャー.webp", "subWeapon":"タンサンボム", "specialWeapon":"ナイスダマ", "subWeaponImageName":"タンサンボム", "specialWeaponImageName":"ナイスダマ"},
      ...
      {"id":66, "name":"モップリンD","attribute":"スロッシャー","imageUrl":"モップリンD.webp", "subWeapon":"ジャンプビーコン", "specialWeapon":"ホップソナー", "subWeaponImageName":"ジャンプビーコン", "specialWeaponImageName":"ホップソナー"},
      // --- スピナー ---
      ...
      {"id":74, "name":"クーゲルシュライバー・ヒュー","attribute":"スピナー","imageUrl":"クーゲルシュライバー・ヒュー.webp", "subWeapon":"トラップ", "specialWeapon":"キューインキ", "subWeaponImageName":"トラップ", "specialWeaponImageName":"キューインキ"},
      ...
      {"id":82, "name":"スプラマニューバーコラボ","attribute":"マニューバー","imageUrl":"スプラマニューバーコラボ.webp", "subWeapon":"カーリングボム", "specialWeapon":"ウルトラチャクチ", "subWeaponImageName":"カーリングボム", "specialWeaponImageName":"ウルトラチャクチ"},
      ...
      {"id":84, "name":"ケルビン525デコ","attribute":"マニューバー","imageUrl":"ケルビン525デコ.webp", "subWeapon":"ポイントセンサー", "specialWeapon":"ウルトラショット", "subWeaponImageName":"ポイントセンサー", "specialWeaponImageName":"ウルトラショット"},
      ...
      {"id":90, "name":"ガエンFFカスタム","attribute":"マニューバー","imageUrl":"ガエンFFカスタム.webp", "subWeapon":"クイックボム", "specialWeapon":"トリプルトルネード", "subWeaponImageName":"クイックボム", "specialWeaponImageName":"トリプルトルネード"},
      // --- シェルター ---
      ...
      {"id":96, "name":"スパイガジェットソレーラ","attribute":"シェルター","imageUrl":"スパイガジェットソレーラ.webp", "subWeapon":"トーピード", "specialWeapon":"スミナガシート", "subWeaponImageName":"トーピード", "specialWeaponImageName":"スミナガシート"},
      ...
      {"id":98, "name":"24式張替傘・乙","attribute":"シェルター","imageUrl":"24式張替傘・乙.webp", "subWeapon":"ポイズンミスト", "specialWeapon":"ウルトラチャクチ", "subWeaponImageName":"ポイズンミスト", "specialWeaponImageName":"ウルトラチャクチ"},
      // --- ブラスター ---
      ...
      {"id":102, "name":"ホットブラスターカスタム","attribute":"ブラスター","imageUrl":"ホットブラスターカスタム.webp", "subWeapon":"ポイントセンサー", "specialWeapon":"ウルトラチャクチ", "subWeaponImageName":"ポイントセンサー", "specialWeaponImageName":"ウルトラチャクチ"},
      ...
      {"id":112, "name":"S-BLAST91","attribute":"ブラスター","imageUrl":"S-BLAST91.webp", "subWeapon":"クイックボム", "specialWeapon":"ナイスダマ", "subWeaponImageName":"クイックボム", "specialWeaponImageName":"ナイスダマ"},
      // --- フデ ---
      ...
      {"id":118, "name":"フィンセント・ヒュー","attribute":"フデ","imageUrl":"フィンセント・ヒュー.webp", "subWeapon":"ポイントセンサー", "specialWeapon":"マルチミサイル", "subWeaponImageName":"ポイントセンサー", "specialWeaponImageName":"マルチミサイル"},
      // --- ストリンガー ---
      ...
      {"id":120, "name":"トライストリンガーコラボ","attribute":"ストリンガー","imageUrl":"トライストリンガーコラボ.webp", "subWeapon":"スプリンクラー", "specialWeapon":"デコイチラシ", "subWeaponImageName":"スプリンクラー", "specialWeaponImageName":"デコイチラシ"},
      ...
      {"id":122, "name":"LACT-450デコ","attribute":"ストリンガー","imageUrl":"LACT-450デコ.webp", "subWeapon":"スプラッシュシールド", "specialWeapon":"サメライド", "subWeaponImageName":"スプラッシュシールド", "specialWeaponImageName":"サメライド"},
      ...
      // --- ワイパー ---
      {"id":125, "name":"ジムワイパー","attribute":"ワイパー","imageUrl":"ジムワイパー.webp", "subWeapon":"クイックボム", "specialWeapon":"ショクワンダー", "subWeaponImageName":"クイックボム", "specialWeaponImageName":"ショクワンダー"},
      {"id":126, "name":"ジムワイパー・ヒュー","attribute":"ワイパー","imageUrl":"ジムワイパー・ヒュー.webp", "subWeapon":"ポイズンミスト", "specialWeapon":"カニタンク", "subWeaponImageName":"ポイズンミスト", "specialWeaponImageName":"カニタンク"},
      ...
      {"id":130, "name":"デンタルワイパースミ","attribute":"ワイパー","imageUrl":"デンタルワイパースミ.webp", "subWeapon":"スプラッシュシールド", "specialWeapon":"ジェットパック", "subWeaponImageName":"スプラッシュシールド", "specialWeaponImageName":"ジェットパック"}
    ];
