...
exports.initializeDB = exports.getMasterWeapons = exports.sequelize = void 0;
...
exports.sequelize = new sequelize_typescript_1.Sequelize({
    ...
    models: [Weapon_1.WeaponModel],
    logging: false, // SQLログが不要なら false に
});
// ★ DBからマスター武器リストを取得する関数 (ルーム初期化などで使う)
var getMasterWeapons = function () { return __awaiter(void 0, void 0, void 0, function () {
    var weapons, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Weapon_1.WeaponModel.findAll({
            ...
            case 1:
                ...
                return [2 /*return*/, weapons];
            case 2:
                error_1 = _a.sent();
                console.error("Error fetching master weapons:", error_1);
                throw error_1; // エラーを再スロー
            case 3: return [2 /*return*/];
        }
    });
}); };
exports.getMasterWeapons = getMasterWeapons;
var initializeDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    var masterWeaponsData, weaponsToCreate, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                weaponsToCreate = masterWeaponsData.map(function (w) { return ({
                ...
                return [4 /*yield*/, Weapon_1.WeaponModel.bulkCreate(weaponsToCreate)];
            case 2:
                _a.sent();
                console.log("Database initialized with ".concat(masterWeaponsData.length, " master weapons."));
                return [3 /*break*/, 4];
            case 3:
                error_2 = _a.sent();
